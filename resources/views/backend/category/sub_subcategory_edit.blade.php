                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                ...
                                <form method="post" action="{{ route('subsubcategory.update') }}" >
                                    ...
                                    <div class="form-group">
                                        <h5>Sub-SubCategory Albanian  <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <input type="text" name="subsubcategory_name_al" class="form-control" value="{{ $subsubcategories-> subsubcategory_name_al}}">
                                            @error('subsubcategory_name_al')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    </div>
