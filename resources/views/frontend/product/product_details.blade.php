        ...
        <h1 class="name">
            @if(session()->get('language') == 'albanian') {{ $product->product_name_al}} @else {{ $product->product_name_en}} @endif
                ...
                <div class="description-container m-t-20">
                    @if(session()->get('language') == 'albanian') {{ $product->short_descp_al}} @else {{ $product->short_descp_en}} @endif
							...
							<div class="tab-content">
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text">
                                            @if(session()->get('language') == 'albanian') {!! $product->long_descp_al!!} @else {!! $product->long_descp_en!!} @endif
